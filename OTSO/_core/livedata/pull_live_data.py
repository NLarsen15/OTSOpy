...
def fetch_data_Space(urlSpace: str) -> dict | None:
    try:
...
def fetch_data_Mag(urlMag: str) -> dict | None:
    try:
...
def fetch_data_Dst(urlDst: str) -> str | None:
    try:
...
def fetch_data_Kp(urlKp: str) -> str | None:
    try:
...
def save_to_csv_Mag(data: dict, version: int) -> None:

def planet(startaltitude=20,cutoff_comp="Vertical",minaltitude=20,maxdistance=100,maxtime=0,
           ...
           G1=0,G2=0,G3=0,W1=0,W2=0,W3=0,W4=0,W5=0,W6=0,kp=0,by_avg=0,bz_avg=0,n_index=0,b_index=0,sym_h_corrected=0,anti="YES",year=2024,
           ...
           array_of_lats_and_longs=None,spheresize=25, inputcoord="GDZ", Verbose=True, AdaptiveExternalModel=False):
    ...
    planet_result = otso_planet.OTSO_planet(
        ...
        inputcoord, Verbose,AdaptiveExternalModel,

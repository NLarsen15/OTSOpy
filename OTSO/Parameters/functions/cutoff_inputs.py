...
def CutoffInputs(Stations,customlocations,startaltitude,cutoff_comp,minaltitude,maxdistance,maxtime,
    ...
    CutoffInputArray = [RigidityArray,DateArray,MagFieldModel,IntModel,ParticleArray,IOPTinput,WindArray,Magnetopause,
    coordsystem,gyropercent,EndParams, Station_Array, InputtedStations, CutoffComputation, Rscan, KpS, corenum, LiveData, g, h]

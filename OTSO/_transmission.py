...
if TYPE_CHECKING:
    from ._core.otso_functions.otso_transmission import OTSO_transmission

def transmission(Stations, customlocations=None, **kwargs):

    import psutil
    from dataclasses import fields
    from ._core.otso_functions import otso_transmission
    from ._core.data_classes.transmission_data import TransmissionData

    allowed = {f.name for f in fields(TransmissionData)}
    ...
    TransmissionDataInstance = TransmissionData(
        Stations = Stations, 
    ...
    cone = otso_transmission.OTSO_transmission(TransmissionDataInstance)

...
C  PARMOD(4)  XIND, the solar-wind-magnetosphere driving index, based on Boynton et al. [2011], 
...
C
      A(1) =1.D0
      A(2) =    1.24658    +0.336862*XIND  -0.151801        *XIND**2
      A(3) =  -0.715258E-01-0.164638*XIND  -0.367849E-01    *XIND**2
      A(4) =   0.927175    +0.504440*XIND  -0.305463        *XIND**2
      A(5) =  -0.501315     -2.41083*XIND   +1.57281        *XIND**2
      A(6) =   0.229589E-01 +3.14061*XIND   -1.24458        *XIND**2
      A(7) =  -0.148657    -0.595892*XIND   +0.330181       *XIND**2
      A(8) =   0.611957     +2.22629*XIND  -0.693097        *XIND**2
      A(9) =   0.496858     -1.63361*XIND   +0.405342       *XIND**2
      A(10)=   0.418382E-01+0.550920*XIND  -0.242575        *XIND**2
      A(11)=   0.251425    +0.383031*XIND  -0.124622        *XIND**2
      A(12)=   0.351328    +0.461355*XIND  -0.322270        *XIND**2
      A(13)=   0.551920    -0.196532*XIND  +0.117334E-01    *XIND**2
      A(14)=    2.76976     -2.25865*XIND   +1.23850        *XIND**2
      A(15)=    8.66404     +1.22910*XIND   -1.38770        *XIND**2
      A(16)=    6.29907     +1.20617*XIND  -0.535385        *XIND**2
      A(17)=    1.23683    +0.921162*XIND  -0.307567        *XIND**2
      A(18)=   0.734181    +0.149250*XIND  -0.139173        *XIND**2
      A(19)=   0.785365    +0.944347*XIND  -0.377709        *XIND**2
      A(20)=    1.47682     -3.23245*XIND   +1.35563        *XIND**2
      A(21)=    3.39086    -0.918023*XIND  +0.361307        *XIND**2
      A(22)=   0.121136E-02+0.524103*XIND  -0.243464        *XIND**2
      A(23)=   0.367886    -0.632629*XIND  +0.310636        *XIND**2
      A(24)=    3.50792     -3.02391*XIND   +1.14657        *XIND**2
c
...
C
      CALL DIPOLE_SHIELD_15B (X,Y,Z,PS,PDPM,BZIMF,CFX,CFY,CFZ)   !  THE DIPOLE SHIELDING FIELD IS PRESSURE-SCALED INSIDE THE DIPOLE_SHIELD(X,Y,Z,...)
...
C   (2) TAIL15 MODULE 
C
      CALL DEFORM_XZ_YZ_15B_TAIL(PS,PARAMETERS,XX,YY,ZZ,TBX,TBY,TBZ) 
      TX=PARAMETERS(2)*TBX
      TY=PARAMETERS(2)*TBY
      TZ=PARAMETERS(2)*TBZ
c------------------------------------------------------------------------------------------------
...
C
      CALL DEFORM_XZ_YZ_15B_AXI(PS,PARAMETERS,XX,YY,ZZ,SBX,SBY,SBZ) 
      SX=PARAMETERS(3)*SBX
      SY=PARAMETERS(3)*SBY
      SZ=PARAMETERS(3)*SBZ
C
...
C
      CALL DEFORM_XZ_YZ_15B_PART(PS,PARAMETERS,XX,YY,ZZ,PBX,PBY,PBZ) 
      PX=PARAMETERS(4)*PBX
      PY=PARAMETERS(4)*PBY
      PZ=PARAMETERS(4)*PBZ
C
...
C
       CALL R1_FAC_R_15B(Theta00,DTheta00,PS,XX,YY,ZZ,BXR1R_UNSH,
     * BYR1R_UNSH,BZR1R_UNSH)                                      ! THE SUFFIX "R" CORRESPONDS TO REGULAR MODE OF R1 FACs
       CALL R1_R_SHLD_15B (XX,YY,ZZ,PS,BZIMF,Theta00,DTheta00,   !  SHIELDING FIELD FOR THE "R" MODE
...
C
       CALL R1_FAC_A_15B (PS,XX,YY,ZZ,BXR1A_UNSH,BYR1A_UNSH,BZR1A_UNSH) ! THE SUFFIX "A" CORRESPONDS TO TILT-ANTISYMMETRIC MODE OF R1 FACs
       CALL R1_A_SHLD_15B (XX,YY,ZZ,PS,BZIMF,Theta00,DTheta00,          !  SHIELDING FIELD FOR THE "A" MODE
...
c
      SUBROUTINE TAIL15_SHIELDED_15B (X,Y,Z,PARAMETERS,BX,BY,BZ)   
C
...
C
       ...
       CALL TAIL15_UNSHIELDED_15B(DMIDN,PWR,XC,RN,X,Y,Z,HXT15,
     * HYT15,HZT15)
       CALL TAIL15_SHLD_15B(X,Y,Z,BZIMF,PWR,XC,RN,FXT15,FYT15,FZT15)
...
C================================================================================================
c
      SUBROUTINE SRC_SHIELDED_15B (X,Y,Z,PARAMETERS,BX,BY,BZ)   
C
C  INPUT:  X, Y, Z  - CARTESIAN GSM POSITION (IN RE)
C  OUTPUT: BX,BY,BZ - CARTESIAN GSM B-FIELD COMPONENTS
C
...
C
       CALL SRC_UNSH_15B (SRCEPS,SRCSCL,X,Y,Z,HXSRC,HYSRC,HZSRC)
       CALL SRC_SHLD_15B (X,Y,Z,BZIMF,SRCEPS,SRCSCL,FXSRC,FYSRC,FZSRC)
...
C================================================================================================
c
      SUBROUTINE PRC_SHIELDED_15B (X,Y,Z,PARAMETERS,BX,BY,BZ)   
C
C  INPUT:  X, Y, Z  - CARTESIAN GSM POSITION (IN RE)
C  OUTPUT: BX,BY,BZ - CARTESIAN GSM B-FIELD COMPONENTS
C
...
C
       ...
       SPRC=DSIN(PRC_PHI)
C
       CALL PRC_UNSH_NM_15B (PRCEPS,PRCSCL,X,Y,Z,HXPRC1,HYPRC1,HZPRC1)
       CALL PRC_SHLD_NM_15B (X,Y,Z,BZIMF,PRCEPS,PRCSCL,FXPRC1,
     * FYPRC1,FZPRC1)
       BNORMX=HXPRC1+FXPRC1
       BNORMY=HYPRC1+FYPRC1
       BNORMZ=HZPRC1+FZPRC1
C
       CALL PRC_UNSH_DD_15B (PRCEPS,PRCSCL,X,Y,Z,HXPRC2,HYPRC2,HZPRC2)
       CALL PRC_SHLD_DD_15B(X,Y,Z,BZIMF,PRCEPS,PRCSCL,FXPRC2,
     * FYPRC2,FZPRC2)
       BDDX=HXPRC2+FXPRC2
       BDDY=HYPRC2+FYPRC2
       BDDZ=HZPRC2+FZPRC2
C
       CALL PRCS_UNSH_15B (PRCEPS,PRCSCL,X,Y,Z,HXPRCS,HYPRCS,HZPRCS)
       CALL PRCS_SHLD_15B (X,Y,Z,BZIMF,PRCEPS,PRCSCL,FXPRCS,
     * FYPRCS,FZPRCS)
       BSYMX=HXPRCS+FXPRCS
       BSYMY=HYPRCS+FYPRCS
       BSYMZ=HZPRCS+FZPRCS
...
c&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE DEFORM_XZ_YZ_15B_TAIL(PS,PARAMETERS,X,Y,Z,BX,BY,BZ)
C
...
c
      CALL TAIL15_SHIELDED_15B(XAS1,YAS2,ZAS2,PARAMETERS,BX_AS2,BY_AS2,
     *  BZ_AS2)
C
...
c&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE DEFORM_XZ_YZ_15B_AXI(PS,PARAMETERS,X,Y,Z,BX,BY,BZ)
C
C   CALCULATES GSM COMPONENTS OF THE WARPED (IN YZ) & BENT (IN XZ) FIELD, DERIVED FROM A SHIELDED
C    UNTILTED  MODEL TAIL FIELD.
C
...
c  CALCULATE THE UNDEFORMED (NO-TILT) FIELD AT (XAS1,YAS2,ZAS2):
c
      CALL SRC_SHIELDED_15B(XAS1,YAS2,ZAS2,PARAMETERS,BX_AS2,BY_AS2,
     *  BZ_AS2)
C
C   CONVERT THE OBTAINED CARTESIAN BY AND BZ COMPONENTS OF THE "ASTERISKED" B
C   TO CYLINDRICAL ONES, USING THE "UNWARPED" ANGULAR COORDINATE PHIS2 AND ITS
...
c&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE DEFORM_XZ_YZ_15B_PART(PS,PARAMETERS,X,Y,Z,BX,BY,BZ)
C
C   CALCULATES GSM COMPONENTS OF THE WARPED (IN YZ) & BENT (IN XZ) FIELD, DERIVED FROM A SHIELDED
C    UNTILTED  MODEL TAIL FIELD.
C
...
c  CALCULATE THE UNDEFORMED (NO-TILT) FIELD AT (XAS1,YAS2,ZAS2):
c
      CALL PRC_SHIELDED_15B(XAS1,YAS2,ZAS2,PARAMETERS,BX_AS2,BY_AS2,
     *  BZ_AS2)
C
C   CONVERT THE OBTAINED CARTESIAN BY AND BZ COMPONENTS OF THE "ASTERISKED" B
C   TO CYLINDRICAL ONES, USING THE "UNWARPED" ANGULAR COORDINATE PHIS2 AND ITS
...
C=============================================================================================
C
      SUBROUTINE DIPOLE_SHIELD_15B(X,Y,Z,PSI,PDPM,BZIMF,BX,BY,BZ)
C
...
C
  2        CONTINUE
C
             CALL DIPOLE_15B(0.D0,XX-XD1,YY,ZZ,DPERPX,DPERPY,DPERPZ)
C
...
C
  3          CONTINUE
C
            CALL DIPOLE_15B(1.570796327D0,XX-XD2,YY,ZZ,DPARAX,
     * DPARAY,DPARAZ)
...
C$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
C
      SUBROUTINE TAIL15_UNSHIELDED_15B (DMIDN,PW,XC,RN,X,Y,Z,BX,BY,BZ)
      IMPLICIT  REAL * 8  (A - H, O - Z)
C
...
c&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE TAIL15_SHLD_15B (X,Y,Z,BZIMF,PW,XC,RN,FX,FY,FZ)
C
...
C
         IND=IND+21
         CALL T89_2_DISK_THIN_15B (X-SHIFT1,Y,Z-50.D0,RMAX_THIN,BXN,
     * BYN,BZN)
         CALL T89_2_DISK_THIN_15B (X-SHIFT1,Y,Z+50.D0,RMAX_THIN,BXS,
     * BYS,BZS)
         ...
         IND=IND+3
         CALL T89_2_DISK_THIN_15B (X-SHIFT2,Y,Z-70.D0,RMAX_THIN,BXN,
     * BYN,BZN)
         CALL T89_2_DISK_THIN_15B (X-SHIFT2,Y,Z+70.D0,RMAX_THIN,BXS,
     * BYS,BZS)
...
C=======================================================================================
c
      SUBROUTINE T89_2_DISK_THIN_15B (X,Y,Z,RMAX,BX,BY,BZ)
C
...
c&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
c
      SUBROUTINE SRC_UNSH_15B (EPS,SCALE,X,Y,Z,BX,BY,BZ)
      IMPLICIT REAL*8 (A-H,O-Z)
c
C     AUTHOR:  N. A. TSYGANENKO, 2015
...
c
      CALL SRC_AXISYMMETRIC_15B (X_s,Y_s,Z_s,BXas,BYas,BZas)    !  calculate Cartesian B components at primed location
C
      RHO2_s=Y_s**2+Z_s**2
...
C&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE SRC_AXISYMMETRIC_15B (X,Y,Z,BX,BY,BZ)
      IMPLICIT  REAL * 8  (A - H, O - Z)
c
C     AUTHOR:  N. A. TSYGANENKO, 2015
c
...
C     
      CALL SPREAD_LOOP_B_15B (R1,D1,X_AST,Y_AST,Z_AST,BX_AST,BY_AST,
     * BZ_AST)
C
...
C     
      CALL SPREAD_LOOP_B_15B (R2,D2,X,Y,Z,BX2,BY2,BZ2)
C      
      BX=F1*BX1+F2*BX2
      BY=F1*BY1+F2*BY2
      BZ=F1*BZ1+F2*BZ2
...
C==========================================================================
C
      SUBROUTINE SPREAD_LOOP_B_15B (R,D,X,Y,Z,BX,BY,BZ)
C
C     AUTHOR:  N. A. TSYGANENKO, 2015
c
...
C=======================================================================================
C
      SUBROUTINE SRC_SHLD_15B (X,Y,Z,BZIMF,EPS,SCALE,FX,FY,FZ)
C
...
C=====================================================================================
c
      SUBROUTINE PRC_UNSH_NM_15B (EPS,SCALE,X,Y,Z,BX,BY,BZ)
      IMPLICIT REAL*8 (A-H,O-Z)
c
C      AUTHOR:  N. A. TSYGANENKO, 2015
c
...
c
      ...
      Z_s=R_prime*DSIN(Ts)*SP
c
      CALL PRC_NM_UNDEFORMED_15B (X_s,Y_s,Z_s,BXas,BYas,BZas)    !  calculate Cartesian B components at primed location
C
      RHO2_s=Y_s**2+Z_s**2
      R_s=DSQRT(RHO2_s+X_s**2)
      RHO_s=DSQRT(RHO2_s)
...
C&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE PRC_NM_UNDEFORMED_15B (X,Y,Z,BX,BY,BZ)
      IMPLICIT REAL*8 (A-H,O-Z)
      CALL SPHCAR_15B (R,T,P,X,Y,Z,-1)
      CALL BRBTBP_PRC_15B (R,T,P,BR,BT,BP)
      CALL BSPCAR_15B (T,P,BR,BT,BP,BX,BY,BZ)
      RETURN
      END
C
C#########################################################################
C
      SUBROUTINE BRBTBP_PRC_15B (R,T,P,BR,BT,BP)
      USE TSY15B_KEEP
      USE TSY15B_PRC_COEFFS
...
C================================================================================
c
      SUBROUTINE SPHCAR_15B (R,THETA,PHI,X,Y,Z,J)  !   IDENTICAL TO SPHCAR_08 FROM GEOPACK-2008 PACKAGE
C
...
C===========================================================================
c
      SUBROUTINE BSPCAR_15B (THETA,PHI,BR,BTHETA,BPHI,BX,BY,BZ)  !  IDENTICAL TO BSPCAR_08 FROM GEOPACK-2008 PACKAGE
C
...
C=======================================================================================
C
      SUBROUTINE PRC_SHLD_NM_15B (X,Y,Z,BZIMF,EPS,SCALE,FX,FY,FZ)
C
C   CALCULATES: (1) COMPONENTS OF THE TOTAL SHIELDING FIELD VECTOR AT ANY GIVEN POSITION X,Y,Z
C
C   THE OUTPUT VECTOR {FX,FY,FZ} IS USED FOR CHECKING THE MODEL (E.G., LINE TRACING),
...
C==========================================================================================
c
      SUBROUTINE PRC_UNSH_DD_15B (EPS,SCALE,X,Y,Z,BX,BY,BZ)
      IMPLICIT REAL*8 (A-H,O-Z)
c
      DATA DT0 /0.07D0/  !  controls the noon-midnight angular stretch (radians)
c                           typical values: between 0.04 and 0.08; here fixed at 0.07
...
c
      ...
      Z_s=R_prime*DSIN(Ts)*SP
c
      CALL PRC_DD_UNDEFORMED_15B (X_s,Y_s,Z_s,BXas,BYas,BZas)    !  calculate Cartesian B components at primed location
C
      RHO2_s=Y_s**2+Z_s**2
      R_s=DSQRT(RHO2_s+X_s**2)
      RHO_s=DSQRT(RHO2_s)
...
C&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE PRC_DD_UNDEFORMED_15B (X,Y,Z,BX,BY,BZ)
      IMPLICIT REAL*8 (A-H,O-Z)
      X1=-Y
      Y1= X
      CALL SPHCAR_15B (R,T,P,X1,Y1,Z,-1)
      CALL BRBTBP_PRC_15B (R,T,P,BR,BT,BP)
      CALL BSPCAR_15B (T,P,BR,BT,BP,BX1,BY1,BZ)
      BX= BY1
      BY=-BX1
      RETURN
      END
...
C=======================================================================================
C
      SUBROUTINE PRC_SHLD_DD_15B (X,Y,Z,BZIMF,EPS,SCALE,FX,FY,FZ)
C
C   CALCULATES: (1) COMPONENTS OF THE TOTAL SHIELDING FIELD VECTOR AT ANY GIVEN POSITION X,Y,Z
C
C   THE OUTPUT VECTOR {FX,FY,FZ} IS USED FOR CHECKING THE MODEL (E.G., LINE TRACING),
...
C=======================================================================================
c
      SUBROUTINE PRCS_UNSH_15B (EPS,SCALE,X,Y,Z,BX,BY,BZ)
      IMPLICIT REAL*8 (A-H,O-Z)
c
      DATA DT0 /0.07D0/  !  controls the noon-midnight angular stretch (radians)
c              Typical values: between 0.04 and 0.08; here fixed at 0.07
...
c
      ...
      Z_s=R_prime*DSIN(Ts)*SP
c
      CALL PRCS_AXISYMMETRIC_15B (X_s,Y_s,Z_s,BXas,BYas,BZas)    !  calculate Cartesian B components at primed location
C
      RHO2_s=Y_s**2+Z_s**2
      R_s=DSQRT(RHO2_s+X_s**2)
      RHO_s=DSQRT(RHO2_s)
...
C&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE PRCS_AXISYMMETRIC_15B (X,Y,Z,BX,BY,BZ)
      IMPLICIT  REAL * 8  (A - H, O - Z)
      DATA F1,F2,DR,R1,D1,R2,D2,AL,A1,A2,A3,A4,A5,A6,A7,B1,B2,B3,B4,B5,
...
C==========================================================================
C
      SUBROUTINE PRCS_SHLD_15B (X,Y,Z,BZIMF,EPS,SCALE,FX,FY,FZ)
C
...
c&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE R1_FAC_R_15B (Theta00,DTheta00,PS,X,Y,Z,BX,BY,BZ)  ! THE SUFFIX "R" CORRESPONDS TO REGULAR MODE OF R1 FACs
C
...
C--------------------------------------------------------------------------------------------------------------------
C
      SUBROUTINE R1_FAC_A_15B (PS,X,Y,Z,BX,BY,BZ)  !     THE SUFFIX "A" CORRESPONDS TO TILT-ANTISYMMETRIC MODE OF R1 FACs            
...
C===============================================================================================================
C
      SUBROUTINE R1_R_SHLD_15B (X,Y,Z,PSI,BZIMF,TH,DTH,FX,FY,FZ)  
C
...
c%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
C
      SUBROUTINE R1_A_SHLD_15B (X,Y,Z,PSI,BZIMF,TH,DTH,FX,FY,FZ)
C
...
C===================================================================================
c
       SUBROUTINE DIPOLE_15B(PS,X,Y,Z,BX,BY,BZ)  ! USED ONLY IN THE DIPOLE_SHIELD SUBROUTINE AS AN IMAGE SOURCE 
C

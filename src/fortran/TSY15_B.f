...
c----------------------------------------------------------------------------------------
      ...
      EXTERNAL TAIL15_SHIELDED_15B,SRC_SHIELDED_15B,PRC_SHIELDED_15B
...
C   (2) TAIL15 MODULE 
C
      CALL DEFORM_XZ_YZ_15B (PS,PARAMETERS,XX,YY,ZZ,TBX,TBY,TBZ,
     *  TAIL15_SHIELDED_15B) 
      TX=PARAMETERS(2)*TBX
      TY=PARAMETERS(2)*TBY
      TZ=PARAMETERS(2)*TBZ
...
C
      CALL DEFORM_XZ_YZ_15B(PS,PARAMETERS,XX,YY,ZZ,SBX,SBY,SBZ,
     *                     SRC_SHIELDED_15B) 
      SX=PARAMETERS(3)*SBX
      SY=PARAMETERS(3)*SBY
      SZ=PARAMETERS(3)*SBZ
...
C
      CALL DEFORM_XZ_YZ_15B(PS,PARAMETERS,XX,YY,ZZ,PBX,PBY,PBZ,
     *                     PRC_SHIELDED_15B) 
      PX=PARAMETERS(4)*PBX
      PY=PARAMETERS(4)*PBY
      PZ=PARAMETERS(4)*PBZ
...
c&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE DEFORM_XZ_YZ_15B (PS,PARAMETERS,X,Y,Z,BX,BY,BZ,
     *   B_EXT_UNTILTED_15B)
C
...
c
      CALL B_EXT_UNTILTED_15B (XAS1,YAS2,ZAS2,PARAMETERS,BX_AS2,BY_AS2,
     *  BZ_AS2)
C

...
C
      ...
      CALL DIPOLE_SHIELD_15N (X,Y,Z,PS,PDPM,BZIMF,CFX,CFY,CFZ)   !  THE DIPOLE SHIELDING FIELD IS PRESSURE-SCALED INSIDE THE DIPOLE_SHIELD(X,Y,Z,...)
...
C
      ...
      !print *, "Dipole Contributions: ", XX, YY, ZZ
C
c----------------------------------------------------------------------------------------------
C   (2) TAIL15 MODULE 
C

      CALL DEFORM_XZ_YZ_15N_TAIL(PS,PARAMETERS,XX,YY,ZZ,TBX,TBY,TBZ)

      TX=PARAMETERS(2)*TBX
      TY=PARAMETERS(2)*TBY
      TZ=PARAMETERS(2)*TBZ

      !print *, "Tail Contributions: ", TX, TY, ZZ
c------------------------------------------------------------------------------------------------
C
C   (3) AXISYMMETRIC RING CURRENT (SRC)
C     

      CALL DEFORM_XZ_YZ_15N_AXI(PS,PARAMETERS,XX,YY,ZZ,SBX,SBY,SBZ)

      SX=PARAMETERS(3)*SBX
      SY=PARAMETERS(3)*SBY
      SZ=PARAMETERS(3)*SBZ

      !print *, "AxiRing Contributions: ", SX, SY, SZ
C
c------------------------------------------------------------------------------------------------
C
C   (4) PARTIAL RING CURRENT (PRC)
C
      !print *, "[DEBUG] PartRingInput: ", XX, YY, ZZ, PBX, PBY, PBZ

      CALL DEFORM_XZ_YZ_15N_PART(PS,PARAMETERS,XX,YY,ZZ,PBX,PBY,PBZ)

      PX=PARAMETERS(4)*PBX
      PY=PARAMETERS(4)*PBY
      PZ=PARAMETERS(4)*PBZ

      !print *, "PartRing Contributions: ", parameters(4), PX, PY, PZ
C
C------------------------------------------------------------------------------------------------
C
...
C
       ...
       CALL R1_FAC_R_15N(Theta00,DTheta00,PS,XX,YY,ZZ,
     *      BXR1R_UNSH,BYR1R_UNSH,BZR1R_UNSH)      ! REGULAR MODE OF R1 FACs
       CALL R1_R_SHLD_15N(XX,YY,ZZ,PS,BZIMF,Theta00,DTheta00,   !  SHIELDING FIELD FOR THE "R" MODE
...
C
       ...
       !print *, "FAC11 Contributions: ", R1RX, R1RY, R1RZ
C
C-----------------------------------------------------------------------------------------------------
C
...
C
       ...
       CALL R1_FAC_A_15N (PS,XX,YY,ZZ,BXR1A_UNSH,BYR1A_UNSH,BZR1A_UNSH) ! THE SUFFIX "A" CORRESPONDS TO TILT-ANTISYMMETRIC MODE OF R1 FACs
       CALL R1_A_SHLD_15N (XX,YY,ZZ,PS,BZIMF,Theta00,DTheta00,          !  SHIELDING FIELD FOR THE "A" MODE
...
C
       ...
       !print *, "FAC12 Contributions: ", parameters(6), R1AX, R1AY, R1AZ
C
C-------------------------------------------------------------------------------------------------
C
...
C
       ...
       !print *, "Penny Contributions: ", BYPEN, BZPEN
C
...
C
       ...
       !print *, "Final External Field: ", BX, BY, BZ
...
c
      SUBROUTINE TAIL15_SHIELDED_15N (X,Y,Z,PARAMETERS,BX,
     * BY,BZ)   
C
...
C
       ...
       CALL TAIL15_UNSHIELDED_15N (DMIDN,PWR,XC,RN,X,Y,Z,
     *                             HXT15,HYT15,HZT15)
       CALL TAIL15_SHLD_15N (X,Y,Z,BZIMF,PWR,XC,RN,FXT15,FYT15,FZT15)
...
C================================================================================================
c
      SUBROUTINE SRC_SHIELDED_15N (X,Y,Z,PARAMETERS,BX,BY,BZ)   
C
C  INPUT:  X, Y, Z  - CARTESIAN GSM POSITION (IN RE)
C  OUTPUT: BX,BY,BZ - CARTESIAN GSM B-FIELD COMPONENTS
C
...
C
       CALL SRC_UNSH_15N (SRCEPS,SRCSCL,X,Y,Z,HXSRC,HYSRC,HZSRC)
       CALL SRC_SHLD_15N (X,Y,Z,BZIMF,SRCEPS,SRCSCL,FXSRC,FYSRC,FZSRC)
...
C================================================================================================
c
      SUBROUTINE PRC_SHIELDED_15N (X,Y,Z,PARAMETERS,BX,BY,BZ)   
C
C  INPUT:  X, Y, Z  - CARTESIAN GSM POSITION (IN RE)
C  OUTPUT: BX,BY,BZ - CARTESIAN GSM B-FIELD COMPONENTS
C
...
C
     ...
     *                      FXPRC2,FYPRC2,FZPRC2)
       BDDX=HXPRC2+FXPRC2
       BDDY=HYPRC2+FYPRC2
       BDDZ=HZPRC2+FZPRC2
C
       CALL PRCS_UNSH_15N (PRCEPS,PRCSCL,X,Y,Z,HXPRCS,HYPRCS,HZPRCS)
       CALL PRCS_SHLD_15N (X,Y,Z,BZIMF,PRCEPS,PRCSCL,
     *                     FXPRCS,FYPRCS,FZPRCS)
       BSYMX=HXPRCS+FXPRCS
       BSYMY=HYPRCS+FYPRCS
       BSYMZ=HZPRCS+FZPRCS
C
...
c&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE DEFORM_XZ_YZ_15N_TAIL (PS,PARAMETERS,X,Y,Z,BX,BY,BZ)
C
...
c
      ...
      CALL TAIL15_SHIELDED_15N (XAS1,YAS2,ZAS2,PARAMETERS,BX_AS2,BY_AS2,
     *  BZ_AS2)
C
...
c&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE DEFORM_XZ_YZ_15N_AXI (PS,PARAMETERS,X,Y,Z,BX,BY,BZ)
C
C   CALCULATES GSM COMPONENTS OF THE WARPED (IN YZ) & BENT (IN XZ) FIELD, DERIVED FROM A SHIELDED
C    UNTILTED  MODEL TAIL FIELD.
C
...
c
      ...
      CALL SRC_SHIELDED_15N (XAS1,YAS2,ZAS2,PARAMETERS,BX_AS2,BY_AS2,
     *  BZ_AS2)
C
C   CONVERT THE OBTAINED CARTESIAN BY AND BZ COMPONENTS OF THE "ASTERISKED" B
C   TO CYLINDRICAL ONES, USING THE "UNWARPED" ANGULAR COORDINATE PHIS2 AND ITS
...
c&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE DEFORM_XZ_YZ_15N_PART (PS,PARAMETERS,X,Y,Z,BX,BY,BZ)
C
C   CALCULATES GSM COMPONENTS OF THE WARPED (IN YZ) & BENT (IN XZ) FIELD, DERIVED FROM A SHIELDED
C    UNTILTED  MODEL TAIL FIELD.
C
...
c
      ...
      CALL PRC_SHIELDED_15N (XAS1,YAS2,ZAS2,PARAMETERS,BX_AS2,BY_AS2,
     *  BZ_AS2)
...
C=============================================================================================
C
      SUBROUTINE DIPOLE_SHIELD_15N (X,Y,Z,PSI,PDPM,BZIMF,BX,BY,BZ)
C
...
C
  2        CONTINUE
C
             CALL DIPOLE_15N(0.D0,XX-XD1,YY,ZZ,DPERPX,DPERPY,DPERPZ)
C
...
C
  3          CONTINUE
C
            CALL DIPOLE_15N(1.570796327D0,XX-XD2,YY,ZZ,
     *                      DPARAX,DPARAY,DPARAZ)
...
C$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
C
      SUBROUTINE TAIL15_UNSHIELDED_15N (DMIDN,PW,XC,RN,X,Y,Z,BX,BY,BZ)
      IMPLICIT  REAL * 8  (A - H, O - Z)
C
...
c&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE TAIL15_SHLD_15N (X,Y,Z,BZIMF,PW,XC,RN,FX,FY,FZ)
C
...
C
         IND=IND+21
         CALL T89_2_DISK_THIN_15N (X-SHIFT1,Y,Z-50.D0,RMAX_THIN,
     *                             BXN,BYN,BZN)
         CALL T89_2_DISK_THIN_15N (X-SHIFT1,Y,Z+50.D0,RMAX_THIN,
     *                             BXS,BYS,BZS)
         ...
         IND=IND+3
         CALL T89_2_DISK_THIN_15N (X-SHIFT2,Y,Z-70.D0,RMAX_THIN,
     *                             BXN,BYN,BZN)
         CALL T89_2_DISK_THIN_15N (X-SHIFT2,Y,Z+70.D0,RMAX_THIN,
     *                             BXS,BYS,BZS)
...
C=======================================================================================
c
      SUBROUTINE T89_2_DISK_THIN_15N (X,Y,Z,RMAX,BX,BY,BZ)
C
...
c&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
c
      SUBROUTINE SRC_UNSH_15N (EPS,SCALE,X,Y,Z,BX,BY,BZ)
      IMPLICIT REAL*8 (A-H,O-Z)
c
C     AUTHOR:  N. A. TSYGANENKO, 2015
...
c
      CALL SRC_AXISYMMETRIC_15N (X_s,Y_s,Z_s,BXas,BYas,BZas)    !  calculate Cartesian B components at primed location
C
      RHO2_s=Y_s**2+Z_s**2
...
C&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE SRC_AXISYMMETRIC_15N (X,Y,Z,BX,BY,BZ)
      IMPLICIT  REAL * 8  (A - H, O - Z)
c
C     AUTHOR:  N. A. TSYGANENKO, 2015
c
...
C     
      CALL SPREAD_LOOP_B_15N (R1,D1,X_AST,Y_AST,Z_AST,
     *                        BX_AST,BY_AST,BZ_AST)
C
...
C     
      CALL SPREAD_LOOP_B_15N (R2,D2,X,Y,Z,BX2,BY2,BZ2)
C      
      BX=F1*BX1+F2*BX2
      BY=F1*BY1+F2*BY2
      BZ=F1*BZ1+F2*BZ2
...
C==========================================================================
C
      SUBROUTINE SPREAD_LOOP_B_15N (R,D,X,Y,Z,BX,BY,BZ)
C
C     AUTHOR:  N. A. TSYGANENKO, 2015
c
...
C=======================================================================================
C
      SUBROUTINE SRC_SHLD_15N (X,Y,Z,BZIMF,EPS,SCALE,FX,FY,FZ)
C
...
C=====================================================================================
c
      SUBROUTINE PRC_UNSH_NM_15N (EPS,SCALE,X,Y,Z,BX,BY,BZ)
      IMPLICIT REAL*8 (A-H,O-Z)
c
C      AUTHOR:  N. A. TSYGANENKO, 2015
c
...
c
      ...
      Z_s=R_prime*DSIN(Ts)*SP
c
      CALL PRC_NM_UNDEFORMED_15N (X_s,Y_s,Z_s,BXas,BYas,BZas)    !  calculate Cartesian B components at primed location
C
      RHO2_s=Y_s**2+Z_s**2
      R_s=DSQRT(RHO2_s+X_s**2)
      RHO_s=DSQRT(RHO2_s)
...
C&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE PRC_NM_UNDEFORMED_15N (X,Y,Z,BX,BY,BZ)
      IMPLICIT REAL*8 (A-H,O-Z)

      CALL SPHCAR_15N (R,T,P,X,Y,Z,-1)

      CALL BRBTBP_PRC_15N (R,T,P,BR,BT,BP)

      CALL BSPCAR_15N (T,P,BR,BT,BP,BX,BY,BZ)
...
C#########################################################################
C
      SUBROUTINE BRBTBP_PRC_15N (R,T,P,BR,BT,BP)
      USE TSY15N_KEEP
      USE TSY15N_PRC_COEFFS
      IMPLICIT REAL*8 (A-H,O-Z)
C
      IF (KEEP.EQ.0) THEN
       KEEP=1
...
C================================================================================
c
      SUBROUTINE SPHCAR_15N (R,THETA,PHI,X,Y,Z,J)  !   IDENTICAL TO SPHCAR_08 FROM GEOPACK-2008 PACKAGE
C
...
C===========================================================================
c
      SUBROUTINE BSPCAR_15N (THETA,PHI,BR,BTHETA,BPHI,BX,BY,BZ)  !  IDENTICAL TO BSPCAR_08 FROM GEOPACK-2008 PACKAGE
C
...
C=======================================================================================
C
      SUBROUTINE PRC_SHLD_NM_15N (X,Y,Z,BZIMF,EPS,SCALE,FX,FY,FZ)
C
C   CALCULATES: (1) COMPONENTS OF THE TOTAL SHIELDING FIELD VECTOR AT ANY GIVEN POSITION X,Y,Z
C
C   THE OUTPUT VECTOR {FX,FY,FZ} IS USED FOR CHECKING THE MODEL (E.G., LINE TRACING),
...
C==========================================================================================
c
      SUBROUTINE PRC_UNSH_DD_15N (EPS,SCALE,X,Y,Z,BX,BY,BZ)
      IMPLICIT REAL*8 (A-H,O-Z)
c
      DATA DT0 /0.07D0/  !  controls the noon-midnight angular stretch (radians)
c                           typical values: between 0.04 and 0.08; here fixed at 0.07
...
c
      ...
      Z_s=R_prime*DSIN(Ts)*SP
c
      CALL PRC_DD_UNDEFORMED_15N (X_s,Y_s,Z_s,BXas,BYas,BZas)    !  calculate Cartesian B components at primed location
C
      RHO2_s=Y_s**2+Z_s**2
      R_s=DSQRT(RHO2_s+X_s**2)
      RHO_s=DSQRT(RHO2_s)
...
C&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE PRC_DD_UNDEFORMED_15N (X,Y,Z,BX,BY,BZ)
      IMPLICIT REAL*8 (A-H,O-Z)
      X1=-Y
      Y1= X

      CALL SPHCAR_15N (R,T,P,X1,Y1,Z,-1)
...
C=======================================================================================
C
      SUBROUTINE PRC_SHLD_DD_15N (X,Y,Z,BZIMF,EPS,SCALE,FX,FY,FZ)
C
C   CALCULATES: (1) COMPONENTS OF THE TOTAL SHIELDING FIELD VECTOR AT ANY GIVEN POSITION X,Y,Z
C
C   THE OUTPUT VECTOR {FX,FY,FZ} IS USED FOR CHECKING THE MODEL (E.G., LINE TRACING),
...
C=======================================================================================
c
      SUBROUTINE PRCS_UNSH_15N (EPS,SCALE,X,Y,Z,BX,BY,BZ)
      IMPLICIT REAL*8 (A-H,O-Z)
c
      DATA DT0 /0.07D0/  !  controls the noon-midnight angular stretch (radians)
c              Typical values: between 0.04 and 0.08; here fixed at 0.07
...
c
      ...
      Z_s=R_prime*DSIN(Ts)*SP
c
      CALL PRCS_AXISYMMETRIC_15N (X_s,Y_s,Z_s,BXas,BYas,BZas)    !  calculate Cartesian B components at primed location
C
      RHO2_s=Y_s**2+Z_s**2
      R_s=DSQRT(RHO2_s+X_s**2)
      RHO_s=DSQRT(RHO2_s)
...
C&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE PRCS_AXISYMMETRIC_15N (X,Y,Z,BX,BY,BZ)
      IMPLICIT  REAL * 8  (A - H, O - Z)
      DATA F1,F2,DR,R1,D1,R2,D2,AL,A1,A2,A3,A4,A5,A6,A7,B1,B2,B3,B4,B5,
...
C==========================================================================
C
      SUBROUTINE PRCS_SHLD_15N (X,Y,Z,BZIMF,EPS,SCALE,FX,FY,FZ)
C
...
c&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
C
      SUBROUTINE R1_FAC_R_15N (Theta00,DTheta00,PS,X,Y,Z,BX,BY,BZ)  ! THE SUFFIX "R" CORRESPONDS TO REGULAR MODE OF R1 FACs
C
...
C--------------------------------------------------------------------------------------------------------------------
C
      SUBROUTINE R1_FAC_A_15N (PS,X,Y,Z,BX,BY,BZ)  !     THE SUFFIX "A" CORRESPONDS TO TILT-ANTISYMMETRIC MODE OF R1 FACs            
...
C===============================================================================================================
C
      SUBROUTINE R1_R_SHLD_15N (X,Y,Z,PSI,BZIMF,TH,DTH,FX,FY,FZ)  
C
...
c%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
C
      SUBROUTINE R1_A_SHLD_15N (X,Y,Z,PSI,BZIMF,TH,DTH,FX,FY,FZ)
C
...
C===================================================================================
c
       SUBROUTINE DIPOLE_15N(PS,X,Y,Z,BX,BY,BZ)  ! USED ONLY IN THE DIPOLE_SHIELD SUBROUTINE AS AN IMAGE SOURCE 
C

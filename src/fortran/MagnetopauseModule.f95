...
module MagnetoPause
    ...
    real(8) :: ResultCheck, sig, sign, Xtemp1, Ytemp1, Ztemp1
    integer(4) :: SubResult = 0
    
    !$omp threadprivate(a11, a22, a33, a14, a12, a13, a23, &
    !$omp a24, a44, a34, MaxR, &
    !$omp p, r0, alpha, Dp, DpAv, scale, k, sig0, A1, x0, &
    !$omp Angle, radial, xprime, s, t, dip, rotation, theta, &
    !$omp xtemp, ytemp, ztemp, NewX, NewY, NewZ, &
    !$omp ResultCheck, sig, sign, Xtemp1, Ytemp1, Ztemp1, SubResult)

...
c
      SUBROUTINE FILLSWGAPS(OMNIYEAR, DIRECTORY2, length)
     ...
     +ISWFLAG(105430), SYMH(105430), VGSE(105430)
      ...
      CHARACTER(length) :: DIRECTORY2, DIRECTORY
...
c      DO 111 IYEAR=1995,2013
      ...
      WRITE(NAMEIN, '(A, I0, "_IMF_gaps_le_3hrs_filled.txt")') 
     & TRIM(DIRECTORY)// "/", IYEAR
      WRITE(NAMEOUT, '(A, I0, "_IMF_&_SW_gaps_le_3hrs_filled.txt")') 
     & TRIM(DIRECTORY) // "/", IYEAR

...
c
      DATA G2025/0.0D0, -29350.0D0, -1410.3D0, -2556.2D0, 2950.9D0, 
     *  1648.7D0, 1360.9D0, -2404.2D0, 1243.8D0, 453.4D0, 894.7D0, 
     *  799.6D0, 55.8D0, -281.1D0, 12.0D0, -232.9D0, 369.0D0, 187.2D0, 
     *  -138.7D0, -141.9D0, 20.9D0, 64.3D0, 63.8D0, 76.7D0, -115.7D0, 
     *  40.9D0, 14.9D0, -60.8D0, 79.6D0, -76.9D0, -8.8D0, 59.3D0, 
     *  15.8D0, 
     * 2.5D0, -11.2D0, 14.3D0, 23.1D0, 10.9D0, -17.5D0, 2.0D0, -21.8D0,
     * 16.9D0, 14.9D0, -16.8D0, 1.0D0, 4.7D0, 8.0D0, 3.0D0, -0.2D0, 
     * -2.5D0,
     *  -13.1D0, 2.4D0, 8.6D0, -8.7D0, -12.8D0, -1.3D0, -6.4D0, 0.2D0,
     *  2.0D0, 
     *  -1.0D0, -0.5D0, -0.9D0, 1.5D0, 0.9D0, -2.6D0, -3.9D0, 3.0D0,
     *  -1.4D0,
     *  -2.5D0, 2.4D0, -0.6D0, 0.0D0, -0.6D0, -0.1D0, 1.1D0, -1.0D0,
     *  -0.1D0, 
     *  2.6D0, -2.0D0, -0.1D0, 0.4D0, 1.2D0, -1.2D0, 0.6D0, 0.5D0, 
     *  0.5D0, 
     *  -0.1D0, -0.5D0, -0.2D0, -1.2D0, -0.7D0, 0.2D0, -0.9D0, 0.6D0,
     *  0.7D0, 
     *  -0.2D0, 0.5D0, 0.1D0, 0.7D0, 0.0D0, 0.3D0, 0.2D0, 0.4D0, -0.5D0,
     *  -0.4D0/
c
      DATA H2025/ 0.0D0, 0.0D0, 4545.5D0, 0.0D0, -3133.6D0, -814.2D0, 
     * 0.0D0, 
     *  -56.9D0, 237.6D0, -549.6D0, 0.0D0, 278.6D0, -134.0D0, 212.0D0,
     *  -375.4D0, 
     *  0.0D0, 45.3D0, 220.0D0, -122.9D0, 42.9D0, 106.2D0, 0.0D0, 
     *  -18.4D0, 16.8D0, 48.9D0, -59.8D0, 10.9D0, 72.8D0, 0.0D0, 
     *  -48.9D0, 
     *  -14.4D0, -1.0D0, 23.5D0, -7.4D0, -25.1D0, -2.2D0, 0.0D0, 7.2D0, 
     *  -12.6D0, 11.5D0, -9.7D0, 12.7D0, 0.7D0, -5.2D0, 3.9D0, 0.0D0, 
     *  -24.8D0, 12.1D0, 8.3D0, -3.4D0, -5.3D0, 7.2D0, -0.6D0, 0.8D0,
     *  9.8D0, 
     *  0.0D0, 3.3D0, 0.1D0, 2.5D0, 5.4D0, -9.0D0, 0.4D0, -4.2D0,
     * -3.8D0, 
     *  0.9D0, -9.0D0, 0.0D0, 0.0D0, 2.8D0, -0.6D0, 0.1D0, 0.5D0,
     * -0.3D0, 
     *  -1.2D0, -1.7D0, -2.9D0, -1.8D0, -2.3D0, 0.0D0, -1.2D0, 0.6D0,
     *  1.0D0, 
     *  -1.5D0, 0.0D0, 0.6D0, -0.2D0, 0.8D0, 0.1D0, -0.9D0, 0.1D0,
     *  0.2D0, 
     *  0.0D0, -0.9D0, 0.7D0, 1.2D0, -0.3D0, -1.3D0, -0.1D0, 0.2D0, 
     * -0.2D0, 
     *  0.5D0, 0.6D0, -0.6D0, -0.3D0, -0.5D0/
c
      DATA DG25/0.0D0, 12.6D0, 10.0D0, -11.2D0, -5.3D0, -8.3D0, -1.5D0,
     * -4.4D0,
     *  0.4D0, -15.6D0, -1.7D0, -2.3D0, -5.8D0, 5.4D0, -6.8D0, 0.6D0,
     *  1.3D0,
     *  0.0D0, 0.7D0, 2.3D0, 1.0D0, -0.2D0, -0.3D0, 0.8D0, 1.2D0,
     *  -0.8D0, 0.4D0, 0.9D0, -0.1D0, -0.1D0, -0.1D0, 0.5D0, -0.1D0,
     *  -0.8D0,
     *  -0.8D0, 0.9D0, -0.1D0, 0.2D0, 0.0D0, 0.4D0, -0.1D0, 0.3D0,
     *  0.1D0, 0.0D0, 0.3D0/
c
      DATA DH25/0.0D0, 0.0D0, -21.5D0, 0.0D0, -27.3D0, -11.1D0, 0.0D0,
     *  3.8D0, -0.2D0, -3.9D0, 0.0D0, -1.3D0, 4.1D0, 1.6D0, -4.1D0, 
     *  0.0D0,
     *  -0.5D0, 2.1D0, 0.5D0, 1.7D0, 1.9D0, 0.0D0, 0.3D0, -1.6D0,
     *  -0.4D0, 0.8D0, 0.7D0, 0.9D0, 0.0D0, 0.6D0, 0.5D0, -0.7D0, 0.0D0,
     *  -0.9D0, 0.5D0, -0.3D0, 0.0D0, -0.3D0, 0.4D0, -0.3D0, 0.4D0,
     * -0.5D0,
     *  -0.6D0, 0.3D0, 0.2D0/
C
      IY=IYEAR
...
20    ENDDO
C
      IF (Gausschoice == 1) GOTO 4000    !USING CSV GAUSS COEFFICIENTS
      IF (CUSTGAUSS == 1) GOTO 3000      !USING CUSTOM GAUSS COEFFICIENTS
      IF (IY.LT.1905) GOTO 1905          !INTERPOLATE BETWEEN 1900 - 1905
      IF (IY.LT.1910) GOTO 1910          !INTERPOLATE BETWEEN 1905 - 1910
      IF (IY.LT.1915) GOTO 1915          !INTERPOLATE BETWEEN 1910 - 1915
      IF (IY.LT.1920) GOTO 1920          !INTERPOLATE BETWEEN 1915 - 1920      
      IF (IY.LT.1925) GOTO 1925          !INTERPOLATE BETWEEN 1920 - 1925
      IF (IY.LT.1930) GOTO 1930          !INTERPOLATE BETWEEN 1925 - 1930
      IF (IY.LT.1935) GOTO 1935          !INTERPOLATE BETWEEN 1930 - 1935
      IF (IY.LT.1940) GOTO 1940          !INTERPOLATE BETWEEN 1935 - 1940
      IF (IY.LT.1945) GOTO 1945          !INTERPOLATE BETWEEN 1940 - 1945
      IF (IY.LT.1950) GOTO 1950          !INTERPOLATE BETWEEN 1945 - 1950
      IF (IY.LT.1955) GOTO 1955          !INTERPOLATE BETWEEN 1950 - 1955
      IF (IY.LT.1960) GOTO 1960          !INTERPOLATE BETWEEN 1955 - 1960
      IF (IY.LT.1965) GOTO 1965          !INTERPOLATE BETWEEN 1960 - 1965
      IF (IY.LT.1970) GOTO 1970          !INTERPOLATE BETWEEN 1965 - 1970
      IF (IY.LT.1975) GOTO 1975          !INTERPOLATE BETWEEN 1970 - 1975
      IF (IY.LT.1980) GOTO 1980          !INTERPOLATE BETWEEN 1975 - 1980
      IF (IY.LT.1985) GOTO 1985         !INTERPOLATE BETWEEN 1980 - 1985
      IF (IY.LT.1990) GOTO 1990         !INTERPOLATE BETWEEN 1985 - 1990
      IF (IY.LT.1995) GOTO 1995         !INTERPOLATE BETWEEN 1990 - 1995
      IF (IY.LT.2000) GOTO 2000         !INTERPOLATE BETWEEN 1995 - 2000
      IF (IY.LT.2005) GOTO 2005         !INTERPOLATE BETWEEN 2000 - 2005
      IF (IY.LT.2010) GOTO 2010         !INTERPOLATE BETWEEN 2005 - 2010
      IF (IY.LT.2015) GOTO 2015         !INTERPOLATE BETWEEN 2010 - 2015
      IF (IY.LT.2020) GOTO 2020         !INTERPOLATE BETWEEN 2015 - 2020
      IF (IY.LT.2025) GOTO 2025         !INTERPOLATE BETWEEN 2015 - 2020
C
C       EXTRAPOLATE BEYOND 2025:
C
      DT=DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-2025.D0
      DO 40 N=1,105
         G(N)=G2025(N)
         H(N)=H2025(N)
         IF (N.GT.45) GOTO 40
...
C
C       INTERPOLATE BETWEEEN 1905 - 1910:
C
1905    F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1900.D0)/5.D0
      F1=1.D0-F2
      DO 19051 N=1,105
...
19051    ENDDO
      GOTO 300
C
C       INTERPOLATE BETWEEEN 1910 - 1915:
C
1910    F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1905)/5.D0
      F1=1.D0-F2
      DO 19101 N=1,105
...
19101    ENDDO
      GOTO 300
C
C       INTERPOLATE BETWEEEN 1915 - 1920:
C
1915    F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1910)/5.D0
      F1=1.D0-F2
      DO 19151 N=1,105
...
19151    ENDDO
      GOTO 300
C
C       INTERPOLATE BETWEEEN 1920 - 1925:
C
1920    F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1915)/5.D0
      F1=1.D0-F2
      DO 19201 N=1,105
...
C
C       INTERPOLATE BETWEEEN 1925 - 1930:
C
1925    F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1920)/5.D0
      F1=1.D0-F2
      DO 19251 N=1,105
...
C
C       INTERPOLATE BETWEEEN 1930 - 1935:
C
1930    F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1925)/5.D0
      F1=1.D0-F2
      DO 19301 N=1,105
...
C
C       INTERPOLATE BETWEEEN 1935 - 1940:
C
1935    F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1930)/5.D0
      F1=1.D0-F2
      DO 19351 N=1,105
...
C
C       INTERPOLATE BETWEEEN 1940 - 1945:
C
1940    F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1935)/5.D0
      F1=1.D0-F2
      DO 19401 N=1,105
...
C
1945    F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1940)/5.D0
      F1=1.D0-F2
      DO 19451 N=1,105
...
C
1950    F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1945)/5.D0
      F1=1.D0-F2
      DO 19501 N=1,105
...
C
1955    F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1950)/5.D0
      F1=1.D0-F2
      DO 19551 N=1,105
...
C
1960    F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1955)/5.D0
      F1=1.D0-F2
      DO 19601 N=1,105
...
C
1965    F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1960)/5.D0
      F1=1.D0-F2
      DO 19651 N=1,105
...
C
1970    F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1965)/5.D0
      F1=1.D0-F2
      DO 19701 N=1,105
...
C
1975    F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1970)/5.D0
      F1=1.D0-F2
      DO 19751 N=1,105
...
C
1980    F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1975)/5.D0
      F1=1.D0-F2
      DO 19801 N=1,105
...
C
1985    F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1980)/5.D0
      F1=1.D0-F2
      DO 19851 N=1,105
...
C
1990   F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1985)/5.D0
      F1=1.D0-F2
      DO 19901 N=1,105
...
C
1995   F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1990)/5.D0
      F1=1.D0-F2
      DO 19951 N=1,105 
...
C
2000   F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25D0-1995)/5.D0
      F1=1.D0-F2
      DO 20001 N=1,105  !  THE 2000 COEFFICIENTS (G00) GO THROUGH THE ORDER 13, NOT 10
...
C
2005   F2=(FLOAT(IY)+FLOAT(IDAY-1)/365.25-2000)/5.
      F1=1.-F2
      DO 20051 N=1,105
...
C
2010   F2=(DFLOAT(IY)+DFLOAT(IDAY-1)/365.25-2005)/5.
      F1=1.-F2
      DO 20101 N=1,105
...
C
2015   F2=(FLOAT(IY)+FLOAT(IDAY-1)/365.25-2010)/5.
      F1=1.-F2
      DO 20151 N=1,105
...
C
2020   F2=(FLOAT(IY)+FLOAT(IDAY-1)/365.25-2015)/5.
      F1=1.-F2
      DO 20201 N=1,105
...
C
2025   F2=(FLOAT(IY)+FLOAT(IDAY-1)/365.25-2020)/5.
      F1=1.-F2
      DO 20251 N=1,105

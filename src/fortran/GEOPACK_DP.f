...
C*******************************************************************
c
      SUBROUTINE SUN_08 (IYEAR,IDAY,IHOUR,MINVAL,ISEC,GST,SLONG,
     *SRASN,SDEC)
C
...
c=====================================================================================
C
      SUBROUTINE RECALC_08(IYEAR,IDAY,IHOUR,MINVAL,ISEC,VGSEX,
     *VGSEY,VGSEZ)
C
...
C
      CALL SUN_08 (IY,IDAY,IHOUR,MINVAL,ISEC,GST,SLONG,SRASN,SDEC)
C
...
C
     ...
     * -0.5+DFLOAT(IHOUR*3600+MINVAL*60+ISEC)/86400.D0
      T=DJ/36525.D0

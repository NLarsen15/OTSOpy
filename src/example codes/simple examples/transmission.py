...
transmission_inputs   = {"transmissionRstep": 0.001, "transmissionsamples": 20}
...
if __name__ == '__main__':
    ...
    print(transmission_results[0]) # dataframe output containing asymptotic cones for all input locations
    print(transmission_results[-1]) # dataframe output containing asymptotic cones for all input locations
